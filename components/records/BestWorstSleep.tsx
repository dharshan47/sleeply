import { getBestWorstSleep } from "@/app/actions";
      ...
      <div className="bg-white shadow-lg rounded-lg p-8 w-full">
        ...
        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center space-y-6 sm:space-y-0">
          <div className="text-center">
            ...
            <p className="text-3xl font-bold bg-linear-to-r from-green-500 to-green-700 bg-clip-text text-transparent">
              {bestSleep !== undefined
                ? `${bestSleep} hours`
                : "No data available"}
            </p>
          ...
          <div className="text-center">
            ...
            <p className="text-3xl font-bold bg-linear-to-r from-red-500 to-red-700 bg-clip-text text-transparent">
